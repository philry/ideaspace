  ...
  <head>
    ...
    $(function(){
    	$("#changeCode").click(function(){
    		$("#image").attr("src","${pageContext.request.contextPath }/code/show.do?id="+new Date().getTime());
    	});
    });
    </script>
  </head>
	      ...
	      <form action="${pageContext.request.contextPath }/staff/login.do" class="form-horizontal ccc" method="post">
		     ...
		     <div class="form-group">
		       ...
		       <div class="col-sm-2">
			      ...
			      <img id="image" class="img-rounded" src="${pageContext.request.contextPath }/code/show.do" alt="验证码" style="height: 32px; width: 70px;"/>
		       </div>
		       <div class="col-sm-2">
