...
<head>
	...
	<script>
        $(function() {
            ...
            // 	$(this).parent().appendChild("bukewei");
            // }
            // })
        });
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.success){
                        ...
                        $("#loginOn").show();
                        //将信息显示
                        $("#loginNickName").text(data.obj.nickname);
                        //成功后将模态框隐藏,显示登录后的界面
                        $("#login_modal").modal("hide");
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu userinfo cc">
								...
								<li>
									...
									<a href="${pageContext.request.contextPath}/showIndex.do"><i class="glyphicon glyphicon-off"></i>退出登录</a>
								</li>
							</ul>
						</li>
					</ul>
