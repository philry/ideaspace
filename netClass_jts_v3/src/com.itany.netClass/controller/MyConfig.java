...
public class MyConfig extends WebConfigurer {
	...
	public void addViewControllers(ResourceHandlerRegistry registry) {
		...
		registry.addViewController("back_login", "/showLogin")
				...
				.addViewController("front_course","/showFrontCourses")
				.addViewController("back_courseSet","/showBackCourses")
				.addViewController("back_commentManageSet","/showCommentManage")
				.addViewController("back_courseResourceSet","/showBackCourseResource")
                .addViewController("back_commentSet","/showBackComment")
				.addViewController("front_select","/showFrontSelect");
	}
