    ...
    <script>
        $(function() {
            ...
            $("#item-b").click(function(){
                ...
                location.href="${pageContext.request.contextPath}/course/front/showCourses.do";
            });
        ...
        <div class="course">
            ...
            <div class="course-box">
                <div class="course-item">
                    ...
                    <div class="item-b">
                        <a href="">
                            <h4 id="item-b">Java企业级电商项目架构演进之路  Tomcat集群与Redis分布式</h4>
                        </a>
                        <p class="title">
                            <span>实战</span>
                            <span>高级</span>
                ...
                <div class="course-item">
                    <div class="item-t">
                        <img src="${pageContext.request.contextPath}/images/course05.jpg" alt="">
                        <div class="java">
