...
<head>
	...
	<script type="text/javascript">
        $(function () {
            ...
            // 点击切换页面
            $("li[name='back_courseTypeSet']").on('click', function(){
                var name = $(this).attr("name");
                console.log(name);
                $('#frame-id').attr('src', "${pageContext.request.contextPath}/type/findFirstLevel.do");
            });
            $("li[name='back_courseSet']").on("click",function () {
                var name = $(this).attr("name");
                console.log(name);
                $("#frame-id").attr("src","${pageContext.request.contextPath}/course/findAll.do");
            });
            $("li[name='back_commentManageSet']").on("click",function () {
                $("#frame-id").attr("src","${pageContext.request.contextPath}/comment/findAllWait.do");
            });
        });
