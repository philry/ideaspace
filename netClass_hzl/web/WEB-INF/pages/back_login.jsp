...
<head>
    ...
    <script type="text/javascript">
        function changeCode() {
            $("#codeImage").attr("src", "${pageContext.request.contextPath }/admin/getCodeImage.do?codeStr=a9x7&num=1&time=" + new Date().getTime());
        }
...
<div class="containercc div-signin" style="position: relative; top: 50%; margin-top: -215px;">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form action="${pageContext.request.contextPath}/admin/adminLogin.do" class="form-horizontal ccc"
                  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2">
                        ...
                        <img id="codeImage" class="img-rounded"
                             src="${pageContext.request.contextPath }/admin/getCodeImage.do?codeStr=a9x7&num=1"
