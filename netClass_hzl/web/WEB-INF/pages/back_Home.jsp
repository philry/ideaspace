        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                ...
                <div class="welcome">
                    ...
                    <div class="right">${admin.loginName}</div>
                    <div class="exit">
                        <a style="color: inherit;" href="${pageContext.request.contextPath}/showLogin.do">退出</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row user-setting">
                <div class="col-xs-3 user-wrap">
                    <ul class="list-group">
						...
						<li class="list-group-item sys-item active"
							name="${pageContext.request.contextPath}/admin/findAllUser.do">
							<i class="glyphicon glyphicon-user"></i> &nbsp;用户管理
						</li>
						<li class="list-group-item sys-item" name="${pageContext.request.contextPath}/course/findAll.do" >
							<i class="glyphicon glyphicon-facetime-video"></i> &nbsp;课程管理
						</li>
						<li class="list-group-item sys-item"
							name="${pageContext.request.contextPath}/course/findAllCourse.do">
							<i class="glyphicon glyphicon-list"></i> &nbsp;课程类别管理
						</li>
						<li class="list-group-item sys-item" name="${pageContext.request.contextPath}/resource/findAll.do">
							<i class="glyphicon glyphicon-file"></i> &nbsp;资源管理
						</li>
						<li class="list-group-item sys-item" name="${pageContext.request.contextPath}/commentManage/unchecked.do">
                ...
                <div class="col-xs-9" id="userPanel">
                    ...
                    <iframe id="frame-id" src="${pageContext.request.contextPath}/admin/findAllUser.do" width="100%"
